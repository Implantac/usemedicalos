# Retomada — Melhoria #1 (Notificações SLA reais) + refinamentos Melhoria #6

## Passo 1 — Verificação
- [x] `npx tsc --noEmit` — 0 erros (TSC_EXIT=0)
- [x] `npx vitest run` — 148/148 passando
- [x] `npx eslint` — 1127 erros pré-existentes de prettier (não relacionados à Melhoria #1; os arquivos novos/modificados da #1 estão limpos)
