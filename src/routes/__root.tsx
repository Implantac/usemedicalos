...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sistema operacional comercial para distribuidores hospitalares. Inbox universal de cotações, precificação com IA e integração Use Sistemas." },
      { name: "author", content: "USE Medical" },
      { property: "og:title", content: "USE Medical — Inbox de Cotações" },
      { property: "og:description", content: "Sistema operacional comercial para distribuidores hospitalares. Inbox universal de cotações, precificação com IA e integração Use Sistemas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "USE Medical — Inbox de Cotações" },
      { name: "twitter:description", content: "Sistema operacional comercial para distribuidores hospitalares. Inbox universal de cotações, precificação com IA e integração Use Sistemas." },
