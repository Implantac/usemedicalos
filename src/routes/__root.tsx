...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "USE Medical" },
      { title: "USE Medical — Centro de Inteligência Comercial" },
      { name: "description", content: "Sistema Operacional Comercial para distribuidores da saúde. Captura universal, inteligência comercial e precificação estratégica." },
      { name: "author", content: "USE Medical" },
      { property: "og:title", content: "USE Medical — Centro de Inteligência Comercial" },
      { property: "og:description", content: "Sistema Operacional Comercial para distribuidores da saúde. Captura universal, inteligência comercial e precificação estratégica." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "USE Medical — Centro de Inteligência Comercial" },
      { name: "twitter:description", content: "Sistema Operacional Comercial para distribuidores da saúde. Captura universal, inteligência comercial e precificação estratégica." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=JetBrains+Mono:wght@500;600&display=swap" },
    ],
  }),
