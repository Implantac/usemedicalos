...
function InboxPage() {
  ...
  const { quotes, addQuote, updateQuote, updateItem, removeItem, setStatus, togglePin, snoozeQuote, resetDemo } = useQuotes();
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-[1600px] px-3 py-4 sm:px-4">
        ...
        <div className="overflow-hidden rounded-lg border bg-card card-shadow">
          <QuoteInbox quotes={quotes} selectedId={selectedId} onSelect={setSelectedId} onAdvance={setStatus} onTogglePin={togglePin} onSnooze={snoozeQuote} />
        </div>
      </main>
