# TODO — Integração de UI (Roda de Melhorias 2)

- [x] 1. quote-drawer.tsx: captura de motivo de perda (A)
- [x] 2. quote-drawer.tsx: botão "Reusar última cotação" (B)
- [x] 3. dashboard.tsx: card "Conversão por fonte" (C)
